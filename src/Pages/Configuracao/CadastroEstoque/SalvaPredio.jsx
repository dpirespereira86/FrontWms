...
const SalvaPredio = (props) => {
  ...
  function salvarPredio(values) {
    axios
      .post(base + 'v1/' + localStorage.getItem('empresa') + '/predios', values, {
        headers: {
...
SalvaPredio.propTypes = {
  props: PropTypes.any,
  handleSubmit: PropTypes.any,
  atualiza: PropTypes.any,
};

export default SalvaPredio;
